...
do
  ...
  flirt -in ${dir_roi}/lDAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lDAI
  ...
  flirt -in ${dir_roi}/rDAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rDAI
  ...
  flirt -in ${dir_roi}/lVAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lVAI
  ...
  flirt -in ${dir_roi}/rVAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rVAI
  ...
  flirt -in ${dir_roi}/lPI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lPI
  ...
  flirt -in ${dir_roi}/rPI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rPI
  ...
  echo flirt -in ${dir_roi}/lDAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lDAI >> ${basedir}/logs/${sub}_s02.txt
  ...
  echo flirt -in ${dir_roi}/rDAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rDAI >> ${basedir}/logs/${sub}_s02.txt
  ...
  echo flirt -in ${dir_roi}/lVAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lVAI >> ${basedir}/logs/${sub}_s02.txt
  ...
  echo flirt -in ${dir_roi}/rVAI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rVAI >> ${basedir}/logs/${sub}_s02.txt
  ...
  echo flirt -in ${dir_roi}/lPI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_lPI >> ${basedir}/logs/${sub}_s02.txt
  ...
  echo flirt -in ${dir_roi}/rPI -ref ${datadir}/${sub}/data/mprage_brain -applyxfm -init ${datadir}/${sub}/analysis/prepro.feat/reg/standard2highres.mat -out ${datadir}/${sub}/roi/standard2highres_rPI >> ${basedir}/logs/${sub}_s02.txt
