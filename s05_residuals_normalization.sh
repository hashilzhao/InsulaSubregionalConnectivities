...
do
  ...
  do
    fslmeants -i ${datadir}/${sub}/analysis/regressor.feat/stats/res4d -m ${datadir}/${sub}/roi/standard2func_${roi} -o ${datadir}/${sub}/roi/roi_${roi}.txt
     echo fslmeants -i ${datadir}/${sub}/analysis/regressor.feat/stats/res4d -m ${datadir}/${sub}/roi/standard2func_${roi} -o ${datadir}/${sub}/roi/roi_${roi}.txt >> ${basedir}/logs/${sub}_s05.txt
  done
  ...
  echo fslmaths ${datadir}/${sub}/analysis/regressor.feat/stats/res4d -Tmean ${datadir}/${sub}/analysis/regressor.feat/stats/res4d_mean >> ${basedir}/logs/${sub}_s05.txt
  echo fslmaths ${datadir}/${sub}/analysis/regressor.feat/stats/res4d -Tstd ${datadir}/${sub}/analysis/regressor.feat/stats/res4d_std >> ${basedir}/logs/${sub}_s05.txt
  echo fslmaths ${datadir}/${sub}/analysis/regressor.feat/stats/res4d -sub ${datadir}/${sub}/analysis/regressor.feat/stats/res4d_mean -div ${datadir}/${sub}/analysis/regressor.feat/stats/res4d_std -add 100 ${datadir}/${sub}/analysis/regressor.feat/stats/res4d_scaled  >> ${basedir}/logs/${sub}_s05.txt
